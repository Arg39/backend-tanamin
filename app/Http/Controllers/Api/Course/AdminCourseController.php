...
class AdminCourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if ($instructor) {
                $query->where('id_instructor', $instructor);
            }
            ...
            return new TableResource(true, 'Courses retrieved successfully', ['data' => $courses], 200);
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return new PostResource(true, 'Course created successfully', [
                'id' => $course->id,
                'id_category' => $course->id_category,
                'id_instructor' => $course->id_instructor,
                'title' => $course->title,
                ...
                'instructor' => $instructor ? ['id' => $instructor->id, 'first_name' => $instructor->first_name, 'last_name' => $instructor->last_name] : null,
            ]);
        } catch (\Exception $e) {
